  ...
  "DT61-DC28-NG96-UA55": {
    "PLATFORM_CAPTUREPLUS": {
      "restrictions": [
        ...
        {
          "Key": "fieldPresent",
          "Value": "shipping_street_uk"
        },
        {
          "Key": "fieldPresent",
          "Value": "shipping_street2_uk"
        },
        {
          "Key": "fieldPresent",
          "Value": "shipping_city_uk"
        },
        {
          "Key": "fieldPresent",
          "Value": "shipping_state_uk"
        },
        {
          "Key": "fieldPresent",
          "Value": "shipping_zip_code_uk"
        },
        {
      ...
      "bindings": [
        {
          "fields": [
            {
              "element": "country_init",
              "field": "{CountryName}",
              "persistantDisplayField": "{CountryName}",
              "mode": 8
            },
            {
              "element": "shipping_street_uk",
              "field": "{Line1}",
              "persistantDisplayField": "{Line1}",
              "mode": 3
            },
            {
              "element": "shipping_street2_uk",
              "field": "{Line2}",
              "persistantDisplayField": "{Line2}",
              "mode": 3
            },
            {
              "element": "shipping_city_uk",
              "field": "{City}",
              "persistantDisplayField": "{City}",
              "mode": 2
            },
            {
              "element": "shipping_state_uk",
              "field": "{Province}",
              "persistantDisplayField": "{Province}",
              "mode": 2
            },
            {
              "element": "shipping_zip_code_uk",
              "field": "{PostalCode}",
